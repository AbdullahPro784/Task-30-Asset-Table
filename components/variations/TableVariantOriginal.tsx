...
import { IntegratedChart } from "../Modals/IntegratedChart";
...
export default function TableVariantOriginal({ data: initialData }: { data: Asset[] }) {
    const {
        table,
        data,
                                                                ...
                                                                >
                                                                    {cell.column.id === "serial" && (
                                                                        <div className="absolute left-0 top-0 bottom-0 pointer-events-none">
                                                                            <TreeConnector row={row} table={table} />
                                                                        </div>
                                                                    )}
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        style={{ paddingLeft: cell.column.id === "serial" ? `${(row.depth * 40) + 12}px` : undefined }}
                                                                    >
